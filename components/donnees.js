...
export const FAQ = [
  ["Combien coûte une mission Cap. ?", "Le tarif est unique, forfaitaire, annoncé avant tout engagement et payable en deux fois au maximum. Nous ne l'affichons pas sur cette page parce qu'il n'a de sens qu'une fois votre situation regardée : selon le dossier, il représente une fraction de ce que vous récupérez la première année, ou une dépense inutile que nous vous déconseillons nous-mêmes de faire."],
