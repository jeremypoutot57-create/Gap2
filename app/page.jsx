        ...
        <section id="temoignages">
          <div className="wrap">
            <div className="u-temo-tete">
              ...
              <div className="note-bloc" style={{ margin: "0" }}>
                <div><div className="n">4,6<small> / 5</small></div><span className="et">★★★★★</span></div>
                <p>35 avis publics sur Google, tous cabinets d'Arras Patrimoine confondus</p>
              </div>
            </div>

            <div className="u-temos" id="temos">
              <article className="u-temo u-temo--texte">
                <span className="u-temo-secteur">Avis Google</span>
                ...
                <small>Mathieu F. · Investisseur et professionnel libéral</small>
              </article>
              <article className="u-temo u-temo--texte">
                <span className="u-temo-secteur">Avis Google</span>
                <span className="et">★★★★★</span>
                <p>« Conseils avisés, suivi hors pair à chaque étape du projet, réactivité. Je recommande à 1000 %. »</p>
                <small>Angélique M. · Investisseuse et cadre</small>
              </article>
              <article className="u-temo u-temo--texte">
                <span className="u-temo-secteur">Avis Google</span>
                <span className="et">★★★★★</span>
                <p>« Des conseils adaptés, un suivi exceptionnel : l'équipe sait trouver des solutions correspondant aux besoins de chacun. »</p>
                <small>Sifi Z. · Cadre</small>
              </article>
            </div>

            <div className="u-verbatims">
              <b>Ce qu'on entend après la restitution</b>
              <p>« Personne me l'avait jamais montré comme ça. »</p>
              <p>« J'aurais dû faire ça il y a cinq ans. »</p>
              <small>Phrases entendues en rendez-vous, jamais attribuées. Les témoignages nominatifs s'ajoutent au fil des dossiers livrés.</small>
            </div>
          </div>
        </section>
